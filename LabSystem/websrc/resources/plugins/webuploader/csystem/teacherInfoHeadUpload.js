// 图片上传demo
	jQuery(function() {
	    ...
	    uploader = WebUploader.create({
	        ...
	        // 文件接收服务端。
	        server: BASE_URL+'/teacher/uploaderImg',
	   ...
	   $("#saveButton").click(function(){
			...
			var teacherIdVal=$("#workCode").val();		//学号
			var teachernameVal=$("#teachername").val();	//姓名
			//var classIdVal=$("#classId").val();	//班级
			
			if(teacherIdVal==null||teacherIdVal==''){
				layer.tips('学号不能为空', '#workCode');
				return;
			}

			if(teachernameVal==null||teachernameVal==''){
				layer.tips('姓名不能为空', '#teachername');
				return;
			}
...
//			}
			...
			if(uploader.getFiles()[0]!=null){
			   	uploader.options.formData={workCode:teacherIdVal}; 
		    	uploader.upload();
		    	return;
			}
